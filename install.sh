...
git clone "https://github.com/vmunich/nov12-01_core.git" "/home/bridgechain/core-bridgechain" || FAILED="Y"
if [ "$FAILED" == "Y" ]; then
    echo "Failed to fetch core repo with origin 'https://github.com/vmunich/nov12-01_core.git'"
